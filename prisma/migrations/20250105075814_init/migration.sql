-- CreateEnum
CREATE TYPE "CommentType" AS ENUM ('COMMENT', 'POST');

-- CreateEnum
CREATE TYPE "LikeType" AS ENUM ('POST', 'COMMENT');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('LIKE', 'POST', 'COMMENT');
...
-- CreateIndex
CREATE INDEX "Comment_authorId_postId_parentId_idx" ON "Comment"("authorId", "postId", "parentId");
...
-- AddForeignKey
ALTER TABLE "Notification" ADD CONSTRAINT "Notification_triggererId_fkey" FOREIGN KEY ("triggererId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
